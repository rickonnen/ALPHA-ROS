...
export const ContactCardDesktop = ({
  id_publicacion,
  objPropietario,
  strTituloInmueble,
}: ContactoProps) => {
      ...
      <div className="flex flex-row items-center justify-between w-full">
        ...
        <div className="flex flex-col gap-3 min-w-[320px] xl:min-w-[360px]">
          ...
          >
            <Button
              variant="outline"
              className="w-full border-2 border-[#1F3A4D] text-[#1F3A4D] bg-transparent hover:bg-[#1F3A4D]/5 font-bold h-14 text-sm lg:text-base rounded-xl transition-all shadow-sm flex items-center justify-center"
            >
