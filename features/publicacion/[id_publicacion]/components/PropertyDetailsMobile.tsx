...
export const PropertyDetailsMobile = ({ objInfo }: PerfilDetallesProps) => {
  ...
  return (
    <div className="flex md:hidden flex-col gap-4">
      ...
      {/* ── DATOS GENERALES ── */}
      <section className="bg-white/60 rounded-2xl p-5 border border-black/5">
        <h2 className="text-xl font-bold mb-6 text-[#1F3A4D]">Datos Generales</h2>
      ...
      {(!bolEsTerreno || bolTieneCaracteristicas) && (
        <section className="bg-white/60 rounded-2xl p-5 border border-black/5">
          <h2 className="text-xl font-bold mb-6 text-[#1F3A4D]">Datos Específicos</h2>
