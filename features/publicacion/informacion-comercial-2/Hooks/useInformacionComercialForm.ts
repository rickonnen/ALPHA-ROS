...
import { formatPriceInput, parseFormattedPrice } from "./useInformacionComercialPrecio";
...
export function useInformacionComercialForm() {
  ...
  function handleSiguiente() {
    ...
    console.log("id_usuario a guardar:", user?.id ?? "");
    ...
    // Guardar datos del paso 1 con id_usuario del contexto de autenticación
    guardarPaso1(form, user?.id ?? "");
    router.push("/publicacion/Caracteristicas");
  }
