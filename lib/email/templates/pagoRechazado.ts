      ...
      <div style="max-width:600px;margin:0 auto;background:white">
        ...
        <div style="padding:32px 48px;color:#333">
          ...
          <div style="text-align:center;padding:16px 0">
            <a href="https://alpha-ros-deploy.vercel.app/cobros/sector-pagos?planId=${planId}&modalidad=${modalidad}"
          ...
          <p style="margin:24px 0 0 0;font-size:12px;color:#999;border-top:1px solid #eee;padding-top:16px">
            ...
            <a href="mailto:soportepropbol@gmail.com" style="color:#1F3A4D;text-decoration:none;font-weight:600">soportepropbol@gmail.com</a>
          </p>
        </div>
      </div>
    </body>
