  ...
  return `
    ...
    <body style="margin:0;padding:0;background-color:#ffffff;font-family:'Segoe UI',Arial,sans-serif">
      <div style="max-width:600px;margin:0 auto;background:white">
        ...
        <div style="background:#9B2335;padding:28px 24px;text-align:center;color:white;border-radius:10px;margin:0 24px">
        ...
        <div style="padding:32px 48px;color:#333">
          ...
          <div style="background:#FEF2F2;padding:16px;border-radius:8px;margin:20px 0;border-left:4px solid #9B2335;border:1px solid #FECACA">
            <p style="margin:0 0 8px 0;font-size:12px;color:#9B2335;font-weight:700;text-transform:uppercase">Motivo del rechazo:</p>
            <p style="margin:0;font-size:15px;color:#991B1B">"${motivo}"</p>
          </div>

          <p style="margin:20px 0 16px 0;font-size:14px;color:#666;line-height:1.6">
            Por favor revisa el motivo mencionado y vuelve a subir tu comprobante de pago para activar tu suscripción.
          </p>

          <div style="text-align:center;padding:16px 0">
            <a href="https://alpha-ros-deploy.vercel.app/cobros/sector-pagos"
               style="display:inline-block;background:#9B2335;color:white;padding:12px 32px;text-decoration:none;border-radius:6px;font-weight:600;font-size:14px">
