export function templateBlogRechazado(
  nombre: string,
  tituloBlog: string
): string {
    ...
    <body style="margin:0;padding:0;background-color:#ffffff;font-family:'Segoe UI',Arial,sans-serif">
      <div style="max-width:600px;margin:0 auto;background:white">
        ...
        <div style="background:#9B2335;padding:28px 24px;text-align:center;color:white;border-radius:10px;margin:0 24px">
          <h1 style="margin:0;font-size:22px;font-weight:700">Publicación No Aprobada</h1>
          <p style="margin:8px 0 0 0;font-size:13px;opacity:0.9">Tu blog requiere correcciones</p>
        </div>
        ...
        <div style="padding:32px 48px;color:#333">
          ...
          <p style="margin:0 0 20px 0;font-size:14px;line-height:1.6">
            Lamentamos informarte que tu publicación <strong>no fue aprobada</strong> en esta ocasión.
            Puedes corregirla y volver a enviarla para revisión.
          </p>

          <div style="background:#FDF0F2;padding:16px;border-radius:8px;border-left:4px solid #9B2335">
            <table style="width:100%;border-collapse:collapse">
              ...
              <tr>
                ...
                <td style="font-size:13px;font-weight:700;color:#9B2335">No aprobado ✗</td>
              </tr>
            </table>
          </div>
