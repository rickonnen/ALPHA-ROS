...
export function LinkedInConfirmVincular({ onClose, onConfirm }: ConfirmProps) {
  return (
    <ConfirmModal
      icon={<IconCadenaVerde />}
      iconBg="bg-green-50"
      title="PROPBOL QUIERE UTILIZAR LINKEDIN PARA VINCULAR TU CUENTA"
...
export function LinkedInSuccessVincular({ onClose }: BaseProps) {
  return (
    <ConfirmModal
      icon={<IconCheckVerde />}
      iconBg="bg-green-50"
      title="LinkedIn vinculado correctamente!"
      description="LinkedIn se vinculo exitosamente a tu cuenta. A partir de ahora podras iniciar sesion de forma rapida y segura."
      confirmText="Aceptar"
      confirmDark
...
export function LinkedInConfirmDesvincular({ onClose, onConfirm }: ConfirmProps) {
  return (
    <ConfirmModal
      icon={<IconCadenaRota />}
      iconBg="bg-red-50"
      title="DESVINCULAR LINKEDIN?"
      description="Si desvincula tu cuenta, perderas el acceso rapido mediante LinkedIn. Deseas continuar?"
...
export function LinkedInSuccessDesvincular({ onClose }: BaseProps) {
  return (
    <ConfirmModal
      icon={<IconCadenaRota />}
      iconBg="bg-red-50"
      title="LinkedIn desvinculado!"
      description="Tu cuenta de LinkedIn ha sido desvinculada. Ya no podras iniciar sesion a traves de LinkedIn."
      confirmText="Aceptar"
      confirmDark
      autoDismissSeconds={7}
      onConfirm={onClose}
...
export function LinkedInError({ onClose }: BaseProps) {
  return (
    <ConfirmModal
      icon={<IconXRoja />}
      iconBg="bg-red-50"
