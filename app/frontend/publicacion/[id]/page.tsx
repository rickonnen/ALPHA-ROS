    ...
    <main className="min-h-screen bg-[#F4EFE6] text-[#2E2E2E] p-4 md:p-12 font-[family-name:var(--font-geist-sans)]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12 text-xl">
          <p>
            <span className="font-bold">Direccion:</span> {strDireccion}
          </p>
        </div>
        ...
        <footer className="flex flex-col md:flex-row justify-between items-center gap-4 pt-10 border-t border-black/10">
          <Button
            variant="outline"
            className="w-full md:w-auto border-[#C26E5A] text-[#C26E5A] px-12 py-7 rounded-lg font-bold text-lg hover:bg-[#C26E5A]/5"
          >
            Ver mis publicaciones
          </Button>
          <Button
            className="w-full md:w-auto bg-[#C26E5A] text-white px-12 py-7 rounded-lg font-bold text-lg hover:bg-[#C26E5A]/90 transition-colors"
          >
