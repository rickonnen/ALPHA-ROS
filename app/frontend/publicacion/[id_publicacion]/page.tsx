...
const strReelId = bolEsInstagram && strVideoUrl
  ...
  return (
 <    main className="min-h-screen bg-[#F4EFE6] text-[#2E2E2E] p-4 md:p-12 font-(family-name:--font-geist-sans)">
...
<div className="mb-12 text-xl">
  <p>
    <span className="font-bold text-[#1F3A4D]">Direccion:</span> {strDireccion}
  </p>
</div>
